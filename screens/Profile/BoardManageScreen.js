...
class BoardManageScreen extends React.Component {

    static navigationOptions = ({ screenProps: { i18n, language } }) => ({
        title: I18n.t('Boards Manage'),
    });
    ...
    fetchBoardConfiguration() {
        ...
        API.fetchAPI(this.onSuccess.bind(this), this.onError.bind(this), API.url.BOARD_ITS, {}, {}, API.httpMethods.GET, API.baseURL.hot);
    }
    ...
    onSuccess(json) {
        ...
        let i = 0;
        let boardList = boards.map(device => {
            let item  = new Object();
        ...
        return (
            <View style={homeStyles.container}>
                ...
                <SectionList
                    ...
                    sections={ds}
                    renderItem={({item, section}) => <ListItem title={item.info.board.name}
                                                               detail={item.info.board.model + " " + item.info.board.version}/>}
...
export default BoardManageScreen;
